...
const features = [
  ...
  },
  {
    ...
    icon: <FaPassport className="text-4xl text-sky-500 mb-4" />,
  },
];
  ...
  return (
    <section id="features" className="pb-40">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-blue-800">
          Our Services
        </h2>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {features.map((feature, idx) => (
            <Fade key={idx} cascade triggerOnce>
              <div className="px-6 py-16 bg-gradient-to-b from-white to-sky-100 rounded-2xl shadow hover:shadow-lg transition flex flex-col items-center h-full min-h-[280px]">
                {feature.icon}
